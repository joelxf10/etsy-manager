...
import { Search, Package, Truck, CheckCircle, XCircle, ChevronDown, ChevronUp, AlertCircle, Upload, Store, Filter, Download } from 'lucide-react'
    ...
    <div className="p-8">
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => downloadCSV('orders', ['Order#','Store','SKU','Color','Size','Qty','Buyer','City','Country','Status','Date'], filteredOrders.map(o => [o.order_number, o.store_name, o.sku, o.color, o.size, o.quantity, o.buyer_name, o.city, o.country, o.status, o.order_date]))}
