...
import { Image as ImageIcon, AlertTriangle, Check, Search, RefreshCw, Eye, Store, ExternalLink, Filter, Download } from 'lucide-react'
    ...
    <div className="p-8">
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => downloadCSV('image_duplicates', ['Group','Store','Product/Variant','Type','URL'], duplicateGroups.flatMap((g, idx) => g.images.map(i => [idx + 1, i.store_name, i.variant_name || i.product_title || '', i.type, i.url])))}
