...
import { Store, Package, ShoppingCart, DollarSign, TrendingUp, Clock, Globe, BarChart3, Download } from 'lucide-react'
    ...
    <div className="p-8">
      <div className="flex justify-between items-start mb-8">
        ...
        <div className="flex items-center gap-3">
          <button onClick={() => downloadCSV('etsy_dashboard_orders', ['Date','Order#','Store','Color','Size','Qty','Price','Status'], orders.map(o => [o.order_date, o.order_number || o.etsy_order_id, o.store_name, o.color || o.etsy_color || '', o.size || o.etsy_size || '', o.qty || 1, o.price_item || o.total_price || 0, o.status || o.order_status || 'OK']))} className="flex items-center gap-2 px-4 py-2 bg-white border rounded-lg text-sm hover:bg-gray-50"><Download className="w-4 h-4" />Export CSV</button>
