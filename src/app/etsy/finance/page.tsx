...
import { DollarSign, TrendingUp, Package, Store, Calendar, PieChart, BarChart3, ArrowUpRight, ArrowDownRight, Download } from 'lucide-react'
    ...
    <div className="p-8">
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="flex gap-2 items-center">
          <button
            onClick={() => downloadCSV('finance_orders', ['Date','Order#','Store','Color','Size','Qty','Price GBP','Cost USD','Status'], filteredOrders.map(o => [o.order_date, o.order_number, o.store_name, o.etsy_color, o.etsy_size, o.qty, (o.price_item || 0) * (o.qty || 1), (o.resolved_cost_usd || 0) + (o.resolved_shipping_usd || 0), o.order_status]))}
