...
import { Package, Search, ChevronDown, ChevronUp, ExternalLink, ImageOff, Download } from 'lucide-react'
  ...
  return (
    <div className="p-8">
      <div className="flex justify-between items-start mb-6">
        ...
        <button
          onClick={() => downloadCSV('products', ['Store','SKU','Title','Variants'], products.map(p => [p.store_name, p.sku, p.title, variants.filter(v => v.store_product_id === p.id).length]))}
