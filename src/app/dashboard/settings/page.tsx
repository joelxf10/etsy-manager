...
export default function SettingsPage() {
  ...
  const roleDescriptions: Record<string, string> = {
    ...
    finance: 'Finance, PNL, and Exceptions only',
    store_manager: 'Dashboard, Orders, Products (no costs)',
    supplier: 'Supplier Picklist only',
  }
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl border p-6">
            ...
            {showAddStore && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-xl p-6 w-full max-w-md" data-tour="store-form">
                ...
                stores.map(store => (
                  <div key={store.id} className="flex items-center justify-between p-3 border rounded-lg">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Code: {store.code} {store.owner && `• Owner: ${store.owner}`}</p>
                    </div>
          ...
          <div className="bg-white rounded-xl border p-6">
            ...
            {showAddUser && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-xl p-6 w-full max-w-md" data-tour="user-form">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="finance">Finance - Finance & Exceptions only</option>
                        <option value="store_manager">Store Manager - Orders & Products (no costs)</option>
                        <option value="supplier">Supplier - Picklist only</option>
                      </select>
                    </div>
                  </div>
                  <div className="flex justify-end gap-2 mt-6">
