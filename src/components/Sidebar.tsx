...
import { ShoppingBag, LayoutDashboard, Package, ClipboardList, DollarSign, Camera, Users, HelpCircle, ChevronLeft, Store, FileText, Palette, CreditCard, Receipt, Link2, Truck } from 'lucide-react'
