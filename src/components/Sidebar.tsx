...
import { ShoppingBag, LayoutDashboard, Package, ClipboardList, DollarSign, Camera, Users, HelpCircle, ChevronLeft, Store, FileText, Palette, CreditCard, Receipt, Link2, Truck, Upload, Image, UserCheck, Calculator, Clock } from 'lucide-react'
...
export default function Sidebar({ platform }: { platform: 'etsy' | 'ebay' }) {
  ...
  const etsyNav = [
    ...
    { name: 'Shipping Calc', href: '/etsy/shipping', icon: Calculator },
  ...
  return (
    <div className="w-64 bg-slate-900 min-h-screen flex flex-col">
      ...
      <div className="p-4 border-t border-slate-800">
        ...
        <Link href="/admin/attendance" className={`flex items-center gap-3 px-3 py-2 rounded-lg ${pathname === '/admin/attendance' ? 'bg-slate-700 text-white' : 'text-gray-400 hover:text-white hover:bg-slate-800'}`}>
